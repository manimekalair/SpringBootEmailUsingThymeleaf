...
[if $DBLibraryCount > 0]
  public SchemaTime(java.sql.Time newvalue) {
    setValue( newvalue );
  }

  public SchemaTime(java.sql.ResultSet rst, String colname) throws java.sql.SQLException {
    setValue(rst.getTime(colname));
	isempty = rst.wasNull();
  }
[endif]
...
[if $DBLibraryCount > 0]
  public void prepareStatement(java.sql.PreparedStatement stmt, int paramnr) throws java.sql.SQLException {
    java.sql.Time dsql = new java.sql.Time(getDate().getTime());
	if( isEmpty() )
		stmt.setNull( paramnr, java.sql.Types.TIME );
	else
	    stmt.setTime(paramnr,dsql);
  }
[endif]
