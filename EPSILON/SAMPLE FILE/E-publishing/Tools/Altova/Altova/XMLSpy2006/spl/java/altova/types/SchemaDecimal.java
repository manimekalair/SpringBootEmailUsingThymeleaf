...
[if $DBLibraryCount > 0]
  public SchemaDecimal(java.sql.ResultSet rst, String colname) throws java.sql.SQLException {
    setValue(rst.getBigDecimal(colname));
	isnull = rst.wasNull();
  }
[endif]
...
[if $DBLibraryCount > 0]
  public void prepareStatement(java.sql.PreparedStatement stmt, int paramnr) throws java.sql.SQLException {
	if( isnull )
		stmt.setNull( paramnr, java.sql.Types.NUMERIC );
	else
	    stmt.setBigDecimal(paramnr,value);
  }
[endif]
