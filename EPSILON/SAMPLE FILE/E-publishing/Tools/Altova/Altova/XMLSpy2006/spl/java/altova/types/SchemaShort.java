...
[if $DBLibraryCount > 0]
  public SchemaShort(java.sql.ResultSet rst, String colname) throws java.sql.SQLException {
    setValue(rst.getShort(colname));
	isnull = rst.wasNull();
  }
[endif]
...
[if $DBLibraryCount > 0]
  public void prepareStatement(java.sql.PreparedStatement stmt, int paramnr) throws java.sql.SQLException {
	if( isnull )
		stmt.setNull( paramnr, java.sql.Types.SMALLINT );
	else
	    stmt.setShort(paramnr,value);
  }
[endif]
