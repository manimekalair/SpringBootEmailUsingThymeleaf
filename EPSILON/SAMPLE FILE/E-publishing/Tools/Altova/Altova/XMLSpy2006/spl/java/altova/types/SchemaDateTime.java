...
[if $DBLibraryCount > 0]
  public SchemaDateTime(java.sql.Timestamp newvalue) {
    setValue( newvalue );
  }

  public SchemaDateTime(java.sql.ResultSet rst, String colname) throws java.sql.SQLException {
    setValue( rst.getTimestamp(colname) );
	isempty = rst.wasNull();
  }
[endif]
...
[if $DBLibraryCount > 0]
  public void setValue(java.sql.Timestamp timestamp) {
    ...
    newvalue.setTime( timestamp );
    setValue( newvalue );
	hasTZ = SchemaCalendarBase.TZ_MISSING;  // no timezone-info in database
	offsetTZ = 0;
  }
[endif]
