...
<structure version="3" schemafile="NanonullOrg.xsd" workingxmlfile="NanonullOrg.xml" templatexmlfile="" xsltversion="1" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8">
		...
		<children>
			<template>
				...
				<children>
					...
					<template>
						<editorproperties adding="mandatory" autoaddname="1" editable="1" markupmode="hide" userinfo="Company logo. If the location changes, enter the new location in the Input Field near the top of the document."/>
									...
									<choice>
										<children>
											...
											<choiceoption>
												...
												<children>
													<template>
														<editorproperties adding="mandatory" autoaddname="1" editable="0" markupmode="hide" userinfo="To edit this field, the Address_EU element of this Office element will have to be deleted using a Text View of the document."/>
														<match match="n1:Location"/>
														<children>
															<select ownvalue="1">
																<properties size="0"/>
