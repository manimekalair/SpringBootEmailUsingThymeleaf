...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:mml="http://www.w3.org/1998/Math/MathML">
	...
	-->
	<xsl:template name="rule_450" match="*">
		<!--
		
		-->
		<!-- SET RULE NUMBER, NAME, AND ERROR TYPE -->
		<xsl:variable name="rule_number">450</xsl:variable>
		<xsl:variable name="rule_name">Check MathML alternative graphic type.</xsl:variable>
		...
		<xsl:variable name="hit_list">
			<xml>
				<xsl:for-each select="//disp-formula[(./mml:math|./alternatives/mml:math)][./alternatives/inline-graphic]">
					<hit>
						<type>inline-graphic</type>
						<location>
							<xsl:choose>
				...
				<xsl:for-each select="//inline-formula[./mml:math][./alternatives/graphic]">
					<hit>
						<type>graphic</type>
						<location>
							<xsl:choose>
