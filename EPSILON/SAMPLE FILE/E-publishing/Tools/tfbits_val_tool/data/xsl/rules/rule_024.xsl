...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions">
	...
	-->
	<xsl:template name="rule_024" match="*">
		<!--
		
		-->
		<!-- SET RULE NUMBER, NAME, AND ERROR TYPE -->
		<xsl:variable name="rule_number">024</xsl:variable>
		<xsl:variable name="rule_name">Check for eISBN.</xsl:variable>
				...
				<xsl:otherwise>
					<xsl:element name="tr">
						...
						<xsl:element name="td">
							...
							<xsl:text>No eISBN found.</xsl:text>
						</xsl:element>
					</xsl:element>
				</xsl:otherwise>
			</xsl:choose>
