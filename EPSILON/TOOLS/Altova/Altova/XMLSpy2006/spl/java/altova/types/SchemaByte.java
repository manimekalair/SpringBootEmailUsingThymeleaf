...
[if $DBLibraryCount > 0]
  public SchemaByte(java.sql.ResultSet rst, String colname) throws java.sql.SQLException {
    setValue(rst.getByte(colname));
	isnull = rst.wasNull();
  }
[endif]
...
[if $DBLibraryCount > 0]
  public void prepareStatement(java.sql.PreparedStatement stmt, int paramnr) throws java.sql.SQLException {
	if( isnull )
		stmt.setNull( paramnr, java.sql.Types.TINYINT );
	else
	    stmt.setByte(paramnr,value);
  }
[endif]
