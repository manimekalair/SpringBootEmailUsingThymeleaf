...
[if $DBLibraryCount > 0]
  public SchemaInteger(java.sql.ResultSet rst, String colname) throws java.sql.SQLException {
    setValue(rst.getLong(colname));
	isnull = rst.wasNull();
  }
[endif]
...
[if $DBLibraryCount > 0]
  public void prepareStatement(java.sql.PreparedStatement stmt, int paramnr) throws java.sql.SQLException {
	if( isnull )
	    ...
	    stmt.setBigDecimal(paramnr,bigDecimalValue() );
  }
[endif]
