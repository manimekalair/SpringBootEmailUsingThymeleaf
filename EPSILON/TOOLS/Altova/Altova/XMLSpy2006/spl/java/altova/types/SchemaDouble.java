...
[if $DBLibraryCount > 0]
  public SchemaDouble(java.sql.ResultSet rst, String colname) throws java.sql.SQLException {
    setValue(rst.getDouble(colname));
	isnull = rst.wasNull();
  }
[endif]
...
[if $DBLibraryCount > 0]
  public void prepareStatement(java.sql.PreparedStatement stmt, int paramnr) throws java.sql.SQLException {
	if( isnull )
		stmt.setNull( paramnr, java.sql.Types.DOUBLE );
	else
	    stmt.setDouble(paramnr,value);
  }
[endif]
