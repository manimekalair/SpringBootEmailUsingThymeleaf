	...
	public class Edifact
	{
		...
		public static SchemaDate ToDate(SchemaString sValue, SchemaString sFormat) 
		{
			...
			switch( sFormat.LongValue() )
			{
				...
				case 103:
				{
					...
					date = Lang.DatetimeAdd( date.DateTimeValue(), (new SchemaDuration( 0, 0, (weekDay-1), 0, 0, 0, 0.0, true ) ) ).DateValue();
		...
		public static SchemaTime ToTime(SchemaString sValue, SchemaString sFormat)
		{
			...
			switch( sFormat.LongValue() )
			{
				...
				case 401:
				{
					...
					result 	= new SchemaTime( hour, minute, 0 );
				}
				break;
				...
				case 402:
				{
					...
					result 	= new SchemaTime( hour, minute, seconds );
				}
					break;
				...
				case 405:
				{
					...
					seconds	= Convert.ToInt32( new String( arrValue, i, 2 ) );	i += 2;
					result 	= new SchemaTime( minute / 60, minute % 60, seconds );
				}
				break;
		...
		public static SchemaDuration ToDuration(SchemaString sValue, SchemaString sFormat)
		{
			...
			switch( sFormat.LongValue() )
			{
				...
				case 709:
				{
					...
					result = Lang.DatetimeDiff( from, to );
				}
					break;
				...
				case 720:
				{
					...
					SchemaDateTime to = new SchemaDateTime( from.Value.Year, from.Value.Month, from.Value.Day, toTH, toTM, 0, 0.0 );
				...
				case 801:
				{
					year = Convert.ToInt32( sValue.Value );
				...
				case 802:
				{
					month = Convert.ToInt32( sValue.Value );
				...
				case 803:
				{
					week = Convert.ToInt32( sValue.Value );
				...
				case 804:
				{
					day = Convert.ToInt32( sValue.Value );
				...
				case 805:
				{
					hour = Convert.ToInt32( sValue.Value );
				...
				case 806:
				{
					minute = Convert.ToInt32( sValue.Value );
				...
				case 807:
				{
					seconds = Convert.ToInt32( sValue.Value );
				...
				case 808:
				{
					int semester = Convert.ToInt32( sValue.Value );
				...
				case 809:
				{
					int fourMonth = Convert.ToInt32( sValue.Value );
				...
				case 810:
				{
					int trimester = Convert.ToInt32( sValue.Value );
				...
				case 811:
				{
					int halfMonth = Convert.ToInt32( sValue.Value );
				...
				case 812:
				{
					int tenDays = Convert.ToInt32( sValue.Value );
		...
		public static SchemaString Autoformat(SchemaString sValue, SchemaString sFormat)
		{
			...
			switch( sFormat.LongValue() )
			{
				...
				case 107:
				{
					SchemaLong number = new SchemaLong( Convert.ToInt32( sValue.Value ) );
				...
				case 601:
				{
					SchemaLong number = new SchemaLong( Y2KConvert.Year( Convert.ToInt32( sValue.Value ) ) );
					result = new SchemaString( number.ToString() );
				}
					break;
				...
				case 813:
				{
					SchemaLong number = new SchemaLong( Convert.ToInt32( sValue ) );
					result = new SchemaString( number.ToString() );
				}
					break;
